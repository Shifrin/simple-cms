...
$this->title = One::t('app', 'Request Password Reset');
        ...
        <div class="row shop-login">
            <div class="col-md-6 col-md-offset-3">
                <div class="box-content">
                    ...
                    <p class="text-center">
                        <?= One::t('app', 'Please provide your email that related to your account.') ?>
                    </p>
        ...
        body.on('click', '.btn-submit', function(e) {
            ...
            $.post(form.attr('action'), form.serialize(), function(response) {
                $.each(response.errors, function(attr, messages) {
                    ...
                    form.yiiActiveForm('updateAttribute', 'passwordresetrequestform-' + attr, messages);
                });
            });
        });
