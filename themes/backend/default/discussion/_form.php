...
<div class="discussion-form">
    ...
    <div class="input-buttons">
        ...
        <?= \yii\helpers\Html::a('<i class="ion-android-open"></i> ' . One::t('app', 'Preview'), One::app()->frontUrlManager->createUrl([
            'home/discussion', 'slug' => $model->slug, 'action' => 'preview'
        ]), [
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <?= $form->field($model, 'status', ['template' => '
                        ...
                        {hint}{error}
                    '])->dropDownList(\common\models\Discussion::statusList(), [
                        'prompt' => 'Select'
                    ]) ?>
                    ...
                    <?= $form->field($model, 'author_id', ['template' => '
                        ...
                        {hint}{error}
                    '])->dropDownList(\common\models\Discussion::authorList(), [
                        'prompt' => 'Select'
                    ]) ?>
                </div>
            </div>
...
$js = <<< JS
    $(function() {
        ...
        $('#discussion-publish_at').datetimepicker();
        
        $('#discussion-publish_at').data('DateTimePicker').date('$model->publish_at' == '' ? new Date() :
