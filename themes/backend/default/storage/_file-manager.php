        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    <span class="input-group-addon file-edit" data-toggle="modal" data-target="#edit-modal">
        ...
        <?php if (count($files) > 0) { ?>
            <div class="row files" id="mixitup">
                <?php foreach ($files as $i => $file) { ?>
                    <div class="col-md-3 mix" data-myorder="<?= $i ?>">
                        ...
                        <div class="file-wrap" title="<?= $file['name'] ?>" data-path="<?= \yii\helpers\Url::to(['storage/index', 'path' => $file['path']]) ?>">
                            ...
                            <div class="file-details">
                                ...
                                <?php } ?>
                                <input type="checkbox" class="file-checkbox" name="delete"
