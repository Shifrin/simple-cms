...
class CategoryController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(One::app()->request->post())) {
            if ($model->save()) {
                One::app()->session->setFlash('success', 'Category created successfully.');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(One::app()->request->post())) {
            if ($model->save()) {
                One::app()->session->setFlash('success', 'Category updated successfully.');
                return $this->redirect(['index']);
            } else {
                One::app()->response->format = Response::FORMAT_JSON;
                return ['errors' => $model->getErrors()];
